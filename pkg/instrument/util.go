...
func sendParamToHook(obj *hookObjects, key uint64, params []proc.Parameter) error {
...
func createHookFunctionParameterListT(args []proc.Parameter) (*hookFunctionParameterListT, bool) {
